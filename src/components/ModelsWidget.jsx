  ...
  if (loading) {
    return (
      <div className="unified-glass p-4">
        <h2 className="text-lg font-bold text-gradient-gold mb-3">{t('admin.manageModels')}</h2>
  ...
  return (
    <>
      ...
      <div className="unified-glass p-4">
        ...
        <h2 className="text-lg font-bold text-gradient-gold">{t('admin.manageModels')}</h2>
        <button
          type="button"
